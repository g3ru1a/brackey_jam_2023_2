...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        float BPS = trackBPM / 60f;
        _movementSpeed = (BPS * 4) - trackOffset;
        _jumpDuration = 60f / trackBPM;
    }
    ...
    void FixedUpdate(){
        ...
        if(!_isJumping){
            gameObject.transform.position += _movementSpeed * Vector3.right * Time.fixedDeltaTime;
        }
    }
